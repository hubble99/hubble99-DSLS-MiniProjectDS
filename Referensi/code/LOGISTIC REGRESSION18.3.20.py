# -*- coding: utf-8 -*-
"""
Created on Wed Mar 18 13:59:11 2020
...
y = y.replace('slightly congested', 0)
y = y.replace('smooth', 1)
y = y.replace('blockage', 2)
y = y.replace('congested', 3)
y = y.replace('highly congested', 4)
