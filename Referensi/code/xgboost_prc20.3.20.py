...
# fit model no training data
#objective may be reg:squarederror,reg:squarederror,reg:squaredlogerror,reg:logistic,binary:logistic,binary:logitraw,binary:hinge,count:poisson,survival:cox,multi:softmax,multi:softprob,
